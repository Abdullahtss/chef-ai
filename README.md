...
Start the Backend Server (in the api directory):
cd api
npm run dev
...
📖 How to Use
Add Ingredients: Type an ingredient and click "Add" or press Enter
Build Your List: Add multiple ingredients (e.g., chicken, tomatoes, pasta, garlic)
Generate Recipes: Click the "Generate Recipes" button
Explore Results: Browse through 4-5 AI-generated recipes
View Instructions: Click "Show All Steps" to see complete cooking instructions
🛠️ Tech Stack
Backend
